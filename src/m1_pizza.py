...
def run_test_draw_points_on_circle():
    ...
    # ------------------------------------------------------------------
    title = 'DRAW_POINTS_ON_CIRCLE, Test 4:  8 red dots on a green circle.'
...
def run_test_pizza():
    ...
    title = 'PIZZA test 4:  30 slices, thin (thickness=6) black lines.'
    window = rg.RoseWindow(400, 400, title)
    circle = rg.Circle(rg.Point(200, 200), 150)
    circle.outline_thickness = 20
    pizza(window, circle, 30, 'yellow', 6)
    window.close_on_mouse_click()
...
def run_test_polygon():
    ...
    title = 'POLYGON test 3:  25 segments with thick green lines.'
    window = rg.RoseWindow(500, 500, title)
    circle = rg.Circle(rg.Point(250, 250), 120)
    circle.outline_thickness = 3
    polygon(window, circle, 25, 'green', 16)
    window.continue_on_mouse_click()
...
def polygon(window, circle, number_of_segments, color, thickness):
    ...
    for point in range(len(points) + 1):
        line = rg.Line(point, rg.Point(point - 1))
        line.thickness = thickness
        line.color = color
        line.attach_to(window)
...
def run_test_fancy_polygon():
    ...
    # Test 4:
    title = 'FANCY POLYGON test 4:  20 black lines on red circle, hops = 12.'
    window = rg.RoseWindow(480, 350, title)

    circle = rg.Circle(rg.Point(280, 123), 190)
    circle.fill_color = 'red'
    fancy_polygon(window, circle, 30, 4, 'black', 12)
    window.close_on_mouse_click()
